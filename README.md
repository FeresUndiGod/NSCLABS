...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=FeresUndiGod_NSCLABS&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=FeresUndiGod_NSCLABS)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=FeresUndiGod_NSCLABS&metric=coverage)](https://sonarcloud.io/summary/new_code?id=FeresUndiGod_NSCLABS)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=FeresUndiGod_NSCLABS&metric=bugs)](https://sonarcloud.io/summary/new_code?id=FeresUndiGod_NSCLABS)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=FeresUndiGod_NSCLABS&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=FeresUndiGod_NSCLABS)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=FeresUndiGod_NSCLABS&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=FeresUndiGod_NSCLABS)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=FeresUndiGod_NSCLABS&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=FeresUndiGod_NSCLABS)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=FeresUndiGod_NSCLABS&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=FeresUndiGod_NSCLABS)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=FeresUndiGod_NSCLABS&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=FeresUndiGod_NSCLABS)
